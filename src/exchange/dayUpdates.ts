...
import { Pair, Bundle, Token, UTradeFactory, UTradeDayData, PairDayData, TokenDayData } from "../../generated/schema";
import { ONE_BI, ZERO_BD, ZERO_BI, FACTORY_ADDRESS } from "./utils";

export function updateUtradeDayData(event: ethereum.Event): UTradeDayData {
  ...
  if (utradeDayData === null) {
    ...
    utradeDayData.totalVolumeUSD = ZERO_BD;
    utradeDayData.totalVolumeBNB = ZERO_BD;
    utradeDayData.dailyVolumeUntracked = ZERO_BD;
  }
  utradeDayData.totalLiquidityUSD = utrade.totalLiquidityUSD;
  utradeDayData.totalLiquidityBNB = utrade.totalLiquidityBNB;
  utradeDayData.totalTransactions = utrade.totalTransactions;
  utradeDayData.save();

  return utradeDayData as UTradeDayData;
}
